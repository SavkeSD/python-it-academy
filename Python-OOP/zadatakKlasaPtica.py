### Imamo ptice koje mogu da lete i koje samo mogu da hodaju
...
print(SuperBird.__mro__) ### ovde vidimo redosled nasledjivanja i ako ima neka metoda u dve klase od koje se nasledjuje, vidimo od koje ce se naslediti